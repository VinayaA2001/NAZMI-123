...
import { Heart, ShoppingCart, User, Search, Menu, X, Phone, Mail, Star, Sparkles } from "lucide-react";
...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white text-sm py-3 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 relative z-10">
          <div className="flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full backdrop-blur-sm">
            <Sparkles className="w-3 h-3 text-yellow-300" />
            <span className="font-medium">Free Shipping Above ₹2000</span>
          </div>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            >
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-600 to-amber-800 rounded-full blur-md opacity-20 group-hover:opacity-30 transition-opacity duration-500"></div>
                <Image
                  src="/logo.png"
                ...
                />
                <div className="absolute -inset-1 bg-gradient-to-r from-amber-400 to-amber-600 rounded-full opacity-0 group-hover:opacity-20 blur transition-opacity duration-500"></div>
              </div>
              <div className="ml-4">
                  ...
                  {highlight && (
                    <div className="absolute -top-2 -right-2">
                      <span className="relative flex h-3 w-3">
                        ...
                        <span className="relative inline-flex rounded-full h-3 w-3 bg-gradient-to-br from-red-500 to-red-600 border border-white shadow-lg"></span>
                      </span>
                    </div>
                  )}
                </Link>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="relative">
                ...
                {/* Search Panel */}
                {searchOpen && (
                  <div className="absolute top-full right-0 mt-2 w-96 bg-white rounded-2xl shadow-2xl border border-gray-100 p-6 animate-in slide-in-from-top-5 duration-300">
